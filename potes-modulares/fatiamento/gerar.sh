...
# tampa PE: impressa em pe (saia para baixo, 1262 mm2 contra 950 invertida). O
# deck e o piso da bandeja ficam suspensos -> suporte da mesa, como na tampa.
$P --brim-width 8  --dont-support-bridges=0 --layer-height 0.2 -o saida/5_tampa_pe_r020.gcode prep/tampa_pe.stl
...
python3 miniatura.py saida/5_tampa_pe_r020.gcode prep/tampa_pe.stl
...
python3 camada.py saida/5_tampa_pe_r020.gcode 0.20 camadas/tampa_pe_z020.png
