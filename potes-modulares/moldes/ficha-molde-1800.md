# Ficha de molde — pote 1800 ml (conceito)
...
| | |
|---|---|
| Peca | corpo 1800 ml, PP, parede 1.30 mm, altura 182.0 mm |
| Peso da peca (malha) | 107.3 g |
...
| Volume de injecao por ciclo | 237 cm³ |
| Razao de fluxo L/t estimada | 205 |

## 2. Posticos

| | |
|---|---|
| Postico de cavidade | 212 × 151 × 220 mm |
| Aco lateral em volta da bolsa | 32 mm |
| Aco sob o fundo da bolsa | 35 mm (passagem do bico) |
| Macho, altura total | 280 mm (forma + haste + flange) |
...
| Placa porta-cavidade | 240 |
| Placa impulsora | 30 |
| Placa porta-macho | 50 |
| Calcos (curso de extracao) | 240 |
...
| **Altura de molde fechado** | **663 mm** |
| Curso de extracao | 210 mm |
| **Abertura minima da maquina** | **454 mm** |

> A abertura minima e a conta que reprova maquina em pote alto: altura da peca
> (185) + curso de extracao (210) + queda (60).
...
| cavidade 4 | z = 122 | x = ±95 | y = ±64 |
| cavidade 5 | z = 168 | x = ±95 | y = ±64 |
| macho (bubbler)  | z = 17 | x = ±33 | y = ±17 |
| macho (bubbler)  | z = 17 | x = ±33 | y = ±17 |
| macho (bubbler)  | z = 17 | x = ±33 | y = ±17 |
| macho (bubbler)  | z = 17 | x = ±33 | y = ±17 |
...
|---|---|
| Ciclo estimado | 25 s |
| Pecas/hora (2 cav) | 288 |
| Consumo de resina | 30.9 kg/h |
