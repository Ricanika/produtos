# Ficha de molde — pote 2400 ml (conceito)
...
| | |
|---|---|
| Peca | corpo 2400 ml, PP, parede 1.40 mm, altura 242.0 mm |
| Peso da peca (malha) | 144.4 g |
...
| Volume de injecao por ciclo | 319 cm³ |
| Razao de fluxo L/t estimada | 233 |

## 2. Posticos

| | |
|---|---|
| Postico de cavidade | 212 × 151 × 281 mm |
| Aco lateral em volta da bolsa | 32 mm |
| Aco sob o fundo da bolsa | 35 mm (passagem do bico) |
| Macho, altura total | 344 mm (forma + haste + flange) |
...
| Placa porta-cavidade | 301 |
| Placa impulsora | 30 |
| Placa porta-macho | 50 |
| Calcos (curso de extracao) | 301 |
...
| **Altura de molde fechado** | **785 mm** |
| Curso de extracao | 271 mm |
| **Abertura minima da maquina** | **576 mm** |

> A abertura minima e a conta que reprova maquina em pote alto: altura da peca
> (246) + curso de extracao (271) + queda (60).
...
| cavidade 3 | z = 78 | x = ±88 | y = ±58 |
| cavidade 4 | z = 122 | x = ±88 | y = ±58 |
| cavidade 5 | z = 168 | x = ±95 | y = ±64 |
| cavidade 6 | z = 212 | x = ±95 | y = ±64 |
| macho (bubbler)  | z = 14 | x = ±32 | y = ±17 |
| macho (bubbler)  | z = 14 | x = ±32 | y = ±17 |
| macho (bubbler)  | z = 14 | x = ±32 | y = ±17 |
| macho (bubbler)  | z = 14 | x = ±32 | y = ±17 |
...
|---|---|
| Ciclo estimado | 29 s |
| Pecas/hora (2 cav) | 248 |
| Consumo de resina | 35.8 kg/h |
