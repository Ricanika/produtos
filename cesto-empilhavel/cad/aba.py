...
def passo_xy(p, dy=0.0, lo=0.0, hi=145.0, tol=0.25):
...
def folha(peso, cap, pn, pe, furos, trava, solta, hz, bb,
    ...
    fig.text(0.5, 0.475, "o que mudou: a aba de 10 mm virou QUEM manda no "
             "encaixe — 10/tg 12° = 46,9 mm, e nada mais encosta", ha="center",
             va="center", fontsize=10.6, color="#3d444d")
    fig.text(0.5, 0.452, "os pés ganharam saída nas faces em y (2,6° por "
             "lado): sem ela a boca da cavidade (6,8 mm) é sempre mais "
             "estreita que a língua (10 mm) e o pé nunca entra no pé — "
             "media 106,8 mm", ha="center", va="center", fontsize=10.2,
             color=GRIS)
